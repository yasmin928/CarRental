					...
					<div class="row">
						<div class="col-md-12 col-sm-12 ">
							<div class="x_panel">
								...
								<div class="x_content">
									<br />
									<form action="{{ route('userUpdate',[$user->id]) }} " method = "POST" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
									@csrf
									@method('put')
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input name="name" type="text" id="first-name" value="{{$user->name}}" required="required" class="form-control ">
											</div>
										</div>
										<div class="item form-group">
